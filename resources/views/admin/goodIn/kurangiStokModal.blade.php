  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="kurangiStok" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form wire:submit.prevent="kurangiStok" enctype="multipart/form-data">
            @csrf
