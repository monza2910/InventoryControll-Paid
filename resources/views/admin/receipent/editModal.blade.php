    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form wire:submit.prevent="updatePeminjam" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal" wire:click="closeEdit()">Close</button>
